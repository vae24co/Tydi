<?php
class LaboratoryApp extends Organizr {
	...
	public function create() {
		$this->content['breadcrumb']['title'] = 'Create Laboratory';
		if (App::isPost()) {
			$method = 'POST';
	...
	public function list() {
		$this->content['breadcrumb']['title'] = 'List of Laboratory';
