...
class oStringX {
	...
	// • ==== is → check if variable string » [boolean]
	...
	// • ==== isPattern → Match Pattern » Boolean | String | Array
	public static function isPattern($string, $pattern, $return = 'BOOLEAN', $flags = 0, $offset = 0) {
		if (self::isNotEmpty($string)) {
			// • predefined pattern
